...
import { canViewReports, canViewManagementReports, canViewFinancialSummary } from "@/lib/permissions";
...
function ReportsHubContent() {
  ...
  const reports = [
    { href: "/physio-summary", title: "Salary & Payroll", desc: "Monthly salary, incentives, fines", icon: BarChart3, mgmt: false },
    { href: "/reports/revenue", title: "Revenue Report", desc: "Paid/unpaid breakdown and trends", icon: DollarSign, mgmt: true },
    { href: "/reports/incentive", title: "Incentive Report", desc: "Staff incentive counts and amounts", icon: Stethoscope, mgmt: false },
    { href: "/reports/attendance", title: "Attendance Report", desc: "Present, absent, leave, holiday", icon: CalendarCheck, mgmt: false },
    { href: "/reports/expenses", title: "Expense Report", desc: "Category-wise expense summary", icon: Receipt, mgmt: true },
    { href: "/reports/unpaid", title: "Unpaid Visits", desc: "Outstanding payments until paid", icon: AlertCircle, mgmt: false },
    { href: "/reports/sessions", title: "Session Report", desc: "Outpatient visits and in-patient sessions", icon: ClipboardList, mgmt: false },
  ...
  ].filter((r) => !r.mgmt || canSeeFinancialReports);
