...
export async function runPart25SalaryLineItems() {
  await addColumn("staff_fines", "salary_id", usePostgres ? "VARCHAR" : "TEXT");
  await addColumn("staff_salary_adjustments", "salary_id", usePostgres ? "VARCHAR" : "TEXT");
}
